...
>
> **24 of the 26 sub-modules are built.** The remaining 2 (3.4–3.5, the rest of Module 3) render as greyed-out
...
> (`conftest.py` + `apps/scheduling/tests/` + `apps/calls/tests/` + `apps/runtime/tests/`, **987 passing**).
>
