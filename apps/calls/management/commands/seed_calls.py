    ...
    'downtown': [
        {
            ...
            'logs': [
                ...
                (15, 'info', 'tool', 'find_availability',
                 {'duration_ms': 240, 'tool': 'find_availability',
                ...
                (26, 'info', 'tool', 'book_appointment',
                 ...
                 {'duration_ms': 680, 'tool': 'book_appointment',
        ...
        },
        {
            ...
            'logs': [
                ...
                (20, 'info', 'tool', 'transfer_call',
                 {'duration_ms': 160, 'tool': 'transfer_call',
    ...
    'uptown': [
        {
            ...
            'logs': [
                ...
                (9, 'info', 'tool', 'get_location_hours',
                 {'duration_ms': 180, 'tool': 'get_location_hours', 'arguments': {'day': 'friday'},
                  'ok': True}),
        ...
        },
        {
            ...
            'logs': [
                ...
                (26, 'info', 'tool', 'create_callback_request',
                 ...
                 {'duration_ms': 410, 'tool': 'create_callback_request',
    ...
    'riverside': [
        {
            ...
            'logs': [
                ...
                (13, 'info', 'tool', 'find_availability',
                 {'duration_ms': 295, 'tool': 'find_availability',
        ...
        },
        {
            ...
            'logs': [
                ...
                (9, 'info', 'tool', 'transfer_call',
                 {'duration_ms': 175, 'tool': 'transfer_call',
    ...
    'lakeside': [
        {
            ...
            'logs': [
                ...
                (11, 'info', 'tool', 'get_location_info',
                 {'duration_ms': 210, 'tool': 'get_location_info', 'arguments': {'topic': 'parking'},
                  'ok': True}),
        ...
        },
        {
            ...
            'logs': [
                ...
                (12, 'info', 'tool', 'transfer_call',
                 {'duration_ms': 35, 'tool': 'transfer_call',
